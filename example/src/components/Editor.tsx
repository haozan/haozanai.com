...
const defaultMd = `# 律师朋友圈，也可以很有料

这张海报由 **[青狮龙虾](https://qingclaw.com)** · 青狮海报大师技能生成。
...
在 **青狮龙虾** 里调用「**青狮海报大师**」技能，让 AI 帮你写好内容、排好结构，粘贴到这里，一键生成精美海报，直接发朋友圈。
...
1. 打开 **青狮龙虾**，调用「青狮海报大师」技能生成内容
2. 将生成的 Markdown 内容粘贴到左侧编辑框
3. 如需配图，点击顶部「**插入图片**」上传
4. 切换右上角「**主题**」选择风格
5. 点击「**复制图片**」或「**下载**」，发朋友圈 ✅
